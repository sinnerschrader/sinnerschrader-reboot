(() => {
  ...
  var require_simpleParallax_min = __commonJS((exports, module) => {
    /*!
  ...
  var Parallax = class {
    ...
    init() {
      ...
      new import_simple_parallax_js.default(fastElements, {
        scale: 1.3
      });
      new import_simple_parallax_js.default(mediumElements, {
        scale: 1.2
      });
      new import_simple_parallax_js.default(slowElements, {
        scale: 1.1
      });
    }
  };
